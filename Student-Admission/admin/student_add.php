...
<?php
					...
					$division = $_POST['division'];
						...
						{
							$er++;
							$eshift = "*Please select ocupation";
						}
...
<div class="form-area" style="margin-top:100px;">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="left-side-form">
										<h5><label for="sname">Full Name</label>
										...
										<h5><label for="address">Current Location</label><span class="error">
								...
								<div class="col-md-6">
									<div class="right-side-form">
										<h5><label for="class">Age</label><span class="error">
												<?php print $eclass; ?></span></h5>
										<p><input placeholder="eg. 19" type="text" name="class" value="<?php print $class; ?>"></p>

										<h5><label for="shift">Ocupation</label></h5>
										...
										<p><input placeholder="eg. B+" type="text" name="blgroup" value="<?php print $blgroup; ?>"></p>

										<h5><label for="division">Area of Interest</label></h5>
										<p><select name="division" id="">
												<option value="0">N/A</option>
												<option value="1">Mentorship</option>
												<option value="2">Counseling</option>
												<option value="3">To be a trainor</option>
												<option value="4">To volunteer</option>
