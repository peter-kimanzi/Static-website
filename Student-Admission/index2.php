...
<body>
    <!--================= Header-area ======================-->
    <div class="header-area header-absoulate"style="    background-color: #fff; border-bottom:1px solid black">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="logo" >
                        <a href="../index.php">
                            <span style="color:#000;"> PMAK<span id="na"></span></span>
                        </a>
                    </div>
                </div>
    <!--================== Main menu-area ====================-->
                    ...
                    <div class="widget">
                        ...
                        <div class="footer-menu">
                            <ul>
                                ...
                                <li><a href="? a=index.php">home</a></li>
